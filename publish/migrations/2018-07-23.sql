...
CREATE TABLE `publish_publishsheet` (`id` integer AUTO_INCREMENT NOT NULL PRIMARY KEY, `publish_date` varchar(32) NOT NULL, `publish_time` varchar(32) NOT NULL, `tapd_url` longtext NOT NULL, `sql_before` longtext NULL, `sql_after` longtext NULL, `consul_key` longtext NULL, `status` varchar(32) NOT NULL, `comment` longtext NULL, `reason` longtext NULL, `if_browse` varchar(32) NOT NULL, `if_order` varchar(32) NOT NULL, `if_buy` varchar(32) NOT NULL, `approval_level_id` integer NULL, `creator_id` integer NOT NULL);
